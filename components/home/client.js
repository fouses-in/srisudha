...
export default function Clients() {
  return (
    <div className="bg-white px-6 xl:px-0 max-w-1200 mx-auto py-6 mb-8 pb-14">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 mt-14 w-full gap-4">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 ">
          <ImageCard
            image={"envato"}
            style="border-r-1px border-b-1px  md:border-b-none "
          />
          <ImageCard image={"figma"} style="border-r-1px " />
          <ImageCard image={"sketch"} style="border-r-1px md:border-r-none" />
          <ImageCard image={"google"} style="border-r-1px border-t-1px " />
          <ImageCard image={"slack"} style="border-r-1px border-t-1px " />
          <div className=" border-t-1px p-3 md:p-6 bg-primaryText ">
            <p className="text-gray-300 w-full md:w-2/3 font-light font-Nunito text-sm md:text-[15px]">
