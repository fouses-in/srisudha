...
export default function Excellence() {
  return (
    <div className="max-w-1200 py-14 px-6 xl:px-0  mx-auto flex flex-col md:flex-row  gap-6">
      ...
      <div className="w-full md:w-[56%] ">
        ...
        <div className="font-Poppins leading-[32px] lg:leading-[52px] text-black text-[32px] md:text-[40px]">
          <h3 className="font-semibold">Pioneering Excellence,</h3>
          <h4>Transforming</h4>
          <h4>Businesses</h4>
        </div>
        <p className="font-Nunito text-base md:text-lg md:font-light mt-4 text-[#000E29]">
