...
export default function Teams() {
  return (
    <div className="py-14 pt-20 text-black   bg-[url('/home/team/teambg.png')] bg-cover bg-center">
      <div className="max-w-1200 mx-auto">
        ...
        <div className="flex mt-28 justify-between gap-4 items-start ">
        ...
        <div className="mt-24 mb-28 justify-center flex gap-8">
          {[
            {
            ...
            <div className="flex group hover:bg-black hover:text-white transition-all duration-150  rounded-md self-start flex-col w-72 shadowC p-2 pb-4">
